...
import 'package:ga913_flutter/util/observe_effect.dart';
...
class HomeScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    observeEffect(ref, (effect) {
      effect.when(navigateToDetail: (landmark) {
        context.router.push(DetailRoute(landmark: landmark));
      });
    });
